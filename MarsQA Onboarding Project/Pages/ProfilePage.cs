...
namespace MarsQA.Pages
{
    public class ProfilePage
    {
        ...
        public string GetEditedAvailability(IWebDriver driver)
        {
            Thread.Sleep(1000);
        ...
        public string GetEditedAvailabilityAlertMessage(IWebDriver driver)
        {
            Thread.Sleep(1000);
        ...
        public string GetEditedHours(IWebDriver driver)
        {
            Thread.Sleep(1000);
        ...
        public string GetEditedHoursAlertMessage(IWebDriver driver)
        {
            Thread.Sleep(1000);
        ...
        public string GetEditedEanTarget(IWebDriver driver)
        {
            Thread.Sleep(1000);
        ...
        public string GetEditedEarnTargetAlertMessage(IWebDriver driver)
        {
            Thread.Sleep(1000);
